    ...
    <div className="relative">
      ...
      <div className="fixed bottom-6 right-6 z-40 flex items-center space-x-3">
        <a
          ...
          className="flex items-center justify-center w-12 h-12 bg-green-500 text-white font-bold rounded-full shadow-lg hover:shadow-xl hover:shadow-green-300/50 transition-all duration-300 hover:scale-110"
        >
        ...
        <button
          ...
          className="flex items-center justify-center px-4 py-2 bg-gradient-to-r from-yellow-400 to-yellow-500 text-white font-bold rounded-full shadow-lg hover:shadow-xl hover:shadow-yellow-300/50 transition-all duration-300 animate-pulse hover:animate-none"
        >
          <span className="mr-2">
